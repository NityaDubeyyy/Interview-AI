...
import { 
  ArrowRight, Check, Play, Star, Plus, 
  Search, Video, Brain, Sparkles, Layout,
...
export default function StaffingAgencyPage() {
  ...
  const features = [
    {
      ...
      description: "Your recruiters can't read every resume for every req. Truffle surfaces experience highlights and alignment signals for every candidate — so your team can quickly see who's worth a closer look.",
      bullets: [
        "Surface candidates with experience relevant to your client's role and industry",
      ...
      image: "https://cdn.prod.website-files.com/69846634cdf00025c27f0908/6985b736eef938334ff92099_resume%20screening.svg",
      imageAlt: "Applicant screening software interface"
    },
    {
      id: "feature2",
      navLabel: "Async video interviews",
      title: "Replace the scheduling nightmare with a single link",
      description: "Your recruiters are juggling 20 reqs and 200 candidates. Phone screening all of them isn't a strategy — it's a bottleneck. Send one link. Candidates record answers on their phone, on their time. Your team reviews when they're ready.",
      bullets: [
      ...
      imageAlt: "Man participating in async video interview"
    },
    {
      id: "feature3",
      navLabel: "Talent assessments",
      title: "Find out how candidates actually work before the first shift",
      description: "Placing someone who quits in two weeks costs you twice. Truffle's assessments surface alignment between candidates and your client's way of doing things — so you're sending people who actually fit how the team operates.",
      bullets: [
  ...
  const faqData = {
    Product: [
      ...
      { q: "How does candidate screening software improve quality of hire?", a: "Screening software improves quality of hire by replacing unstructured evaluation with consistent, criteria-based assessment. Every candidate is measured against the same scoring rubric, reducing variability and bias while surfacing alignment signals that phone screens miss." },
      ...
      { q: "Is Truffle's AI biased?", a: "Truffle's AI analyzes only transcripts of candidate responses. Demographic data isn't requested or used in scoring, and every match score includes transparent reasoning so your team can validate the AI's analysis." }
    ],
    Support: [
      ...
      <section style={{ padding: "180px 24px 100px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ display: "inline-block", background: "rgba(255, 255, 255, 0.05)", padding: "8px 16px", borderRadius: "100px", border: "1px solid rgba(255, 255, 255, 0.1)", marginBottom: "32px" }}>
            <span style={{ fontSize: "12px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "2px", color: "rgba(255, 255, 255, 0.6)" }}>staffing agency software</span>
          </div>
          <h1 style={{ fontSize: "clamp(3rem, 6vw, 5rem)", fontWeight: 600, lineHeight: 1.1, marginBottom: "24px", letterSpacing: "-0.04em" }}>
            Screen more candidates without additions more recruiters
          </h1>
          <p style={{ fontSize: "1.25rem", color: "rgba(255, 255, 255, 0.6)", maxWidth: "800px", margin: "0 auto 48px", lineHeight: 1.6 }}>
            Staffing agencies live and die on speed-to-fill. Truffle gives you async interviews, AI summaries, and match scores so your recruiters spend less time screening and more time placing.
          </p>
