...
export default function RetailHiringPage() {
  ...
  const features = [
    {
      ...
      description: "You don't need to read 50 resumes line by line. Truffle surfaces experience highlights and alignment signals for every candidate — so you can quickly see who's worth a closer look.",
      bullets: [
        "Surface candidates with relevant retail, food service, or customer-facing experience",
        "Flag key qualifications like availability, certifications, and location",
      ...
      imageAlt: "Retail resume analysis interface"
    },
    {
      id: "feature2",
      navLabel: "Async video interviews",
      title: "Replace the scheduling nightmare with a single link",
      description: "Phone screens are calendar Tetris — and retail candidates aren't waiting around for a callback next Tuesday. Send one link. Candidates record answers on their phone, on their time. You review when you're ready.",
      bullets: [
    ...
    },
    {
      ...
      description: "Resumes tell you where someone worked. Assessments show you how they approach the job. Truffle's assessments surface alignment between candidates and your team's way of doing things — so your interviews focus on the people who fit how you operate.",
      bullets: [
        "Situational judgment scenarios based on real retail situations",
      ...
      imageAlt: "Retail situational scorecard"
    },
    {
      id: "feature4",
  ...
  return (
    <main style={{ background: "#060212", color: "#fff", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "180px 24px 100px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ display: "inline-block", background: "rgba(255, 255, 255, 0.05)", padding: "8px 16px", borderRadius: "100px", border: "1px solid rgba(255, 255, 255, 0.1)", marginBottom: "32px" }}>
            <span style={{ fontSize: "12px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "2px", color: "rgba(255, 255, 255, 0.6)" }}>retail hiring software</span>
          </div>
          <h1 style={{ fontSize: "clamp(3rem, 6vw, 5rem)", fontWeight: 600, lineHeight: 1.1, marginBottom: "24px", letterSpacing: "-0.04em" }}>
            Hire retail teams at scale with Truffle's applicant screening tools
          </h1>
          <p style={{ fontSize: "1.25rem", color: "rgba(255, 255, 255, 0.6)", maxWidth: "800px", margin: "0 auto 48px", lineHeight: 1.6 }}>
            Retail managers don't have time to screen 50 applicants per role. Truffle gives you async interviews, AI summaries, and match scores so you get to the right conversations faster.
          </p>
      ...
      {/* 7. Retail hiring guides & resources */}
      <section style={{ padding: "100px 24px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ marginBottom: "60px" }}>
            <h2 style={{ fontSize: "2.5rem", fontWeight: 600 }}>Retail hiring guides & resources</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "32px" }}>
            {[
              {
                title: "11 best AI interview software for retail mass hiring in 2026",
                desc: "Hiring for retail is fast-paced and high-volume. This guide breaks down the best AI video tools built for retail teams in 2026.",
                img: "https://cdn.prod.website-files.com/69846636cdf00025c27f0a12/698dcbfe7516d7cc4251cd5c_69887594b31541ec910d3ba4_686bcb6e8a21fc5695b36a47_59d97d0b3c.webp",
                link: "/blog/ai-interview-software-retail-service-hiring"
              },
              {
                title: "Top 10 best retail interview questions",
                desc: "To help you hire top retail employees, here are 10 essential retail interview questions and answers.",
                img: "https://cdn.prod.website-files.com/69846636cdf00025c27f0a12/69c599b594dda946a75ea872_RETAILINTERVIEW.png",
                link: "/blog/retail-interview-questions"
              },
              {
                title: "15 mass hiring strategies that scale your team in 2026",
                desc: "Struggling to scale your team fast? This guide breaks down exact strategies, tools, and workflows for mass hiring.",
                img: "https://cdn.prod.website-files.com/69846636cdf00025c27f0a12/69c5a681127bbdbdc9d9b913_mass%20hiring%20strategies.png",
                link: "/blog/mass-hiring-strategy"
              }
            ].map((blog, i) => (
              <motion.a 
                key={i}
      ...
      {/* 8. Retail Job Descriptions */}
      <section style={{ padding: "80px 24px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            <h2 style={{ fontSize: "2.5rem", fontWeight: 600 }}>Retail job descriptions</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "24px" }}>
            {[
              { title: "Retail inventory specialist", desc: "Use this template to hire staff who manage stock accuracy and inventory tracking.", link: "/job-descriptions/retail-inventory-specialist" },
              { title: "Retail shift supervisor", desc: "Hire retail shift supervisors with this template covering duties and leadership skills.", link: "/job-descriptions/retail-shift-supervisor" },
              { title: "Visual merchandiser", desc: "Use this template to hire creative staff who drive sales through store displays.", link: "/job-descriptions/visual-merchandiser" },
              { title: "Retail customer service representative", desc: "Hire retail customer service reps with this template covering duties and skills.", link: "/job-descriptions/retail-customer-service-representative" },
              { title: "Retail stock associate", desc: "Use this entry-level stock associate job description to hire backroom staff.", link: "/job-descriptions/retail-stock-associate" },
              { title: "Retail store cashier", desc: "Hire retail cashiers with this template covering responsibilities and qualifications.", link: "/job-descriptions/retail-store-cashier" },
              { title: "Retail sales associate", desc: "Use this entry-level retail sales associate template to hire customer-facing staff.", link: "/job-descriptions/retail-sales-associate" }
            ].map((job, i) => (
              <div 
                key={i}
