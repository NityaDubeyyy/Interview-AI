...
export default function TruffleVsIndeed() {
  return (
    <main style={{ backgroundColor: "#ffffff", minHeight: "100vh", color: "#0f172a" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 10 }}>
          ...
          <div style={{ textAlign: "center", maxWidth: "800px", margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "72px", fontWeight: "500", lineHeight: "1.1", marginBottom: "32px", letterSpacing: "-0.02em", color: "#000000" }}>
              "Good enough" video<br />is just video.<br />Truffle adds the brain.
            </h1>
            
            <p style={{ fontSize: "18px", color: "#475569", lineHeight: "1.6", marginBottom: "48px", maxWidth: "600px", margin: "0 auto 48px", fontWeight: "500" }}>
              Indeed offers video interviews. Truffle adds the brain—and<br />
      ...
      <section style={{ padding: "0 24px 80px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ 
            ...
            Truffle adds the brain to video interviews
          </div>
          ...
          <div style={{ 
            ...
            AI-powered insights, not just recordings
          </div>
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <div style={{ borderRadius: "24px", border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.05)" }}>
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", background: "#f8fafc", padding: "24px", borderBottom: "1px solid #e2e8f0", fontWeight: "600", fontSize: "18px" }}>
              ...
              <div style={{ textAlign: "center", color: "#64748b" }}>Indeed</div>
            </div>
            
            {[
              { name: "Asynchronous Video Interviews", truffle: true, indeed: true },
              { name: "Custom Questions & Branding", truffle: true, indeed: false },
              { name: "ATS Integrations", truffle: true, indeed: true },
              { name: "AI-Powered Candidate Ranking", truffle: true, indeed: false, highlight: true },
              { name: "Automated Communication Analysis", truffle: true, indeed: false, highlight: true },
              { name: "Smart Shortlisting", truffle: true, indeed: false, highlight: true },
              { name: "Fraud & Deepfake Detection", truffle: true, indeed: false, highlight: true },
            ].map((row, i) => (
              <div key={i} style={{ 
                display: "grid", 
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  {row.indeed ? <CheckCircle2 color="#64748b" /> : <XCircle color="#cbd5e1" />}
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "32px" }}>
            <FeatureCard 
              ...
              desc="Indeed offers video interviews. Truffle adds the brain—and works across your entire stack."
            />
            <FeatureCard 
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              They switched from Indeed<br />and didn't look back
            </h2>
      ...
      <section style={{ padding: "80px 24px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              The much more affordable Indeed<br />alternative
            </h2>
