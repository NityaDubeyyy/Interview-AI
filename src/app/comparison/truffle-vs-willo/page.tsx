...
const WilloLogo = () => (
  <div style={{color: '#8b5cf6', fontSize: '32px', fontFamily: 'cursive', fontWeight: 'bold', lineHeight: 1, padding: '0 4px'}}>w</div>
);

export default function TruffleVsWillo() {
  return (
    <main style={{ backgroundColor: "#ffffff", minHeight: "100vh", color: "#0f172a" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 10 }}>
          ...
          <div style={{ textAlign: "center", maxWidth: "800px", margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "72px", fontWeight: "500", lineHeight: "1.1", marginBottom: "32px", letterSpacing: "-0.02em", color: "#000000" }}>
              The Willo<br />alternative that doesn't<br />start at $249
            </h1>
            
            <p style={{ fontSize: "18px", color: "#475569", lineHeight: "1.6", marginBottom: "48px", maxWidth: "600px", margin: "0 auto 48px", fontWeight: "500" }}>
              Same one-way video interviews. Built-in AI analysis. Highlight<br />
              reels that cut review time by 80%. All at a fraction of the price.
            </p>

            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "16px", marginBottom: "64px" }}>
              <div style={{ position: "relative" }}>
                {/* Glow effect under the black button */}
                <div style={{ 
                  position: "absolute", 
                  top: "10px", 
                  left: "10%", 
      ...
      <section style={{ padding: "0 24px 80px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ 
            ...
            AI summaries Willo charges extra for
          </div>
          ...
          <div style={{ 
            ...
            Willo just shows completions, Truffle shows fit
          </div>
          ...
          <div style={{ 
            ...
            30 seconds vs watching full Willo recordings
          </div>
          
          {/* Decorative blurred background like the image */}
          <div style={{ 
            position: "absolute", 
            top: "-50px", 
            left: "-50px", 
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <div style={{ borderRadius: "24px", border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.05)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", background: "#f8fafc", padding: "24px", borderBottom: "1px solid #e2e8f0", fontWeight: "600", fontSize: "18px" }}>
              ...
              <div style={{ textAlign: "center", color: "#64748b" }}>Willo</div>
            </div>
            
            {/* Table Rows */}
            {[
              { name: "Asynchronous Video Interviews", truffle: true, willo: true },
              { name: "Custom Questions & Branding", truffle: true, willo: true },
              { name: "ATS Integrations", truffle: true, willo: true },
              { name: "AI-Powered Candidate Ranking", truffle: true, willo: false, highlight: true },
              { name: "Automated Communication Analysis", truffle: true, willo: false, highlight: true },
              { name: "Smart Shortlisting", truffle: true, willo: false, highlight: true },
              { name: "Fraud & Deepfake Detection", truffle: true, willo: false, highlight: true },
            ].map((row, i) => (
              <div key={i} style={{ 
                display: "grid", 
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  {row.willo ? <CheckCircle2 color="#64748b" /> : <XCircle color="#cbd5e1" />}
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "32px" }}>
            <FeatureCard 
              ...
              desc="Willo gives you a folder of videos to watch. Truffle watches them alongside you, analyzes communication skills, and surfaces the best candidates instantly."
            />
            <FeatureCard 
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              They switched from Willo<br />and didn't look back
            </h2>
      ...
      <section style={{ padding: "80px 24px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              The much more affordable Willo<br />alternative
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", alignItems: "start", marginBottom: "32px" }}>
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                width: "300px", 
                height: "300px", 
                background: "radial-gradient(circle, rgba(239,68,68,0.8) 0%, rgba(249,115,22,0.4) 50%, transparent 70%)", 
                filter: "blur(40px)",
                zIndex: 0
              }}></div>
