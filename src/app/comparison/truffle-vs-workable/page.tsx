...
export default function TruffleVsWorkable() {
  return (
    <main style={{ backgroundColor: "#ffffff", minHeight: "100vh", color: "#0f172a" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 10 }}>
          ...
          <div style={{ textAlign: "center", maxWidth: "800px", margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "72px", fontWeight: "500", lineHeight: "1.1", marginBottom: "32px", letterSpacing: "-0.02em", color: "#000000" }}>
              Built-in screening is<br />convenient.<br />Specialized is transformative.
            </h1>
            
            <p style={{ fontSize: "18px", color: "#475569", lineHeight: "1.6", marginBottom: "48px", maxWidth: "600px", margin: "0 auto 48px", fontWeight: "500" }}>
              Workable offers built-in screening. Truffle offers specialized<br />
              screening that transforms your hiring process.
            </p>
      ...
      <section style={{ padding: "0 24px 80px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ 
            ...
            Specialized screening, not just built-in
          </div>
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <div style={{ borderRadius: "24px", border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.05)" }}>
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", background: "#f8fafc", padding: "24px", borderBottom: "1px solid #e2e8f0", fontWeight: "600", fontSize: "18px" }}>
              ...
              <div style={{ textAlign: "center", color: "#64748b" }}>Workable</div>
            </div>
            
            {[
              { name: "Asynchronous Video Interviews", truffle: true, workable: false },
              { name: "Custom Questions & Branding", truffle: true, workable: true },
              { name: "ATS Integrations", truffle: true, workable: true },
              { name: "AI-Powered Candidate Ranking", truffle: true, workable: false, highlight: true },
              { name: "Automated Communication Analysis", truffle: true, workable: false, highlight: true },
              { name: "Smart Shortlisting", truffle: true, workable: false, highlight: true },
              { name: "Fraud & Deepfake Detection", truffle: true, workable: false, highlight: true },
            ].map((row, i) => (
              <div key={i} style={{ 
                display: "grid", 
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  {row.workable ? <CheckCircle2 color="#64748b" /> : <XCircle color="#cbd5e1" />}
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "32px" }}>
            <FeatureCard 
              ...
              desc="Workable offers built-in screening. Truffle offers specialized screening that transforms your hiring process."
            />
            <FeatureCard 
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              They switched from Workable<br />and didn't look back
            </h2>
      ...
      <section style={{ padding: "80px 24px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              The much more affordable Workable<br />alternative
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", alignItems: "start", marginBottom: "32px" }}>
            <div style={{ 
              ...
              <div style={{ 
                ...
                width: "300px", 
                height: "300px", 
                background: "radial-gradient(circle, rgba(5,150,105,0.8) 0%, rgba(16,185,129,0.4) 50%, transparent 70%)", 
                filter: "blur(40px)",
                zIndex: 0
              }}></div>
