    ...
    <main style={{ backgroundColor: "#ffffff", minHeight: "100vh", color: "#0f172a" }}>
      ...
      <section style={{ padding: "0 24px 80px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ 
            ...
            Truffle built a hiring brain, not just an assistant
          </div>
          ...
          <div style={{ 
            ...
            Help make the right choice, not just answer questions
          </div>
          ...
          <div style={{ 
            ...
            right: "-50px", 
            bottom: "-50px", 
            background: "linear-gradient(135deg, #fee2e2 0%, #fecdd3 50%, #fca5a5 100%)", 
            filter: "blur(100px)",
            opacity: 0.3,
            zIndex: 0,
            pointerEvents: "none"
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <div style={{ borderRadius: "24px", border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.05)" }}>
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", background: "#f8fafc", padding: "24px", borderBottom: "1px solid #e2e8f0", fontWeight: "600", fontSize: "18px" }}>
              ...
              <div style={{ textAlign: "center", color: "#64748b" }}>myInterview</div>
            </div>
            
            {[
              { name: "Asynchronous Video Interviews", truffle: true, myInterview: true },
              { name: "Custom Questions & Branding", truffle: true, myInterview: true },
              { name: "ATS Integrations", truffle: true, myInterview: true },
              { name: "AI-Powered Candidate Ranking", truffle: true, myInterview: false, highlight: true },
              { name: "Automated Communication Analysis", truffle: true, myInterview: false, highlight: true },
              { name: "Smart Shortlisting", truffle: true, myInterview: false, highlight: true },
              { name: "Fraud & Deepfake Detection", truffle: true, myInterview: false, highlight: true },
            ].map((row, i) => (
              <div key={i} style={{ 
                display: "grid", 
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  {row.myInterview ? <CheckCircle2 color="#64748b" /> : <XCircle color="#cbd5e1" />}
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              They switched from myInterview<br />and didn't look back
            </h2>
      ...
      <section style={{ padding: "80px 24px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              The much more affordable myInterview<br />alternative
            </h2>
