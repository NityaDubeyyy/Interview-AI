...
const SparkHireLogo = () => (
  <div style={{color: '#f97316', fontSize: '32px', lineHeight: 1}}>🔥</div>
);

export default function TruffleVsSparkHire() {
  return (
    <main style={{ backgroundColor: "#ffffff", minHeight: "100vh", color: "#0f172a" }}>
      ...
      <section style={{ padding: "0 24px 80px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ 
            ...
            AI summaries Spark Hire charges extra for
          </div>
          ...
          <div style={{ 
            ...
            Spark Hire just shows completions, Truffle shows fit
          </div>
          ...
          <div style={{ 
            ...
            30 seconds vs watching full Spark Hire recordings
          </div>
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <div style={{ borderRadius: "24px", border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.05)" }}>
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", background: "#f8fafc", padding: "24px", borderBottom: "1px solid #e2e8f0", fontWeight: "600", fontSize: "18px" }}>
              ...
              <div style={{ textAlign: "center", color: "#64748b" }}>Spark Hire</div>
            </div>
            
            {[
              { name: "Asynchronous Video Interviews", truffle: true, sparkHire: true },
              { name: "Custom Questions & Branding", truffle: true, sparkHire: true },
              { name: "ATS Integrations", truffle: true, sparkHire: true },
              { name: "AI-Powered Candidate Ranking", truffle: true, sparkHire: false, highlight: true },
              { name: "Automated Communication Analysis", truffle: true, sparkHire: false, highlight: true },
              { name: "Smart Shortlisting", truffle: true, sparkHire: false, highlight: true },
              { name: "Fraud & Deepfake Detection", truffle: true, sparkHire: false, highlight: true },
            ].map((row, i) => (
              <div key={i} style={{ 
                display: "grid", 
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  {row.sparkHire ? <CheckCircle2 color="#64748b" /> : <XCircle color="#cbd5e1" />}
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "32px" }}>
            <FeatureCard 
              ...
              desc="Spark Hire gives you a folder of videos to watch. Truffle watches them alongside you, analyzes communication skills, and surfaces the best candidates instantly."
            />
            <FeatureCard 
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              They switched from Spark Hire<br />and didn't look back
            </h2>
      ...
      <section style={{ padding: "80px 24px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "40px", fontWeight: "600", marginBottom: "16px", color: "#0f172a" }}>
              The much more affordable Spark Hire<br />alternative
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", alignItems: "start", marginBottom: "32px" }}>
            <div style={{ 
              ...
              <div style={{ 
                ...
                width: "300px", 
                height: "300px", 
                background: "radial-gradient(circle, rgba(249,115,22,0.8) 0%, rgba(234,88,12,0.4) 50%, transparent 70%)", 
                filter: "blur(40px)",
                zIndex: 0
              }}></div>
